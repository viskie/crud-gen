  ...
  <div class='body-con'>
    	<ul class="align-list">
            <li>
                 ...
                 <input type="text" id="joining_date" name="joining_date" value="" class="hasDatepicker">
                 <input type="hidden" id="joining_date_alt" name="joining_date_alt" size="30" value="">
            </li>
            <!--<li>
            	<label for="photo_img">Select Photo</label>
                <input type="file" id="photo_img" name="photo_img" value="" />
                
                <label for="sign_img">Select Signature</label>
                <input type="file" id="sign_img" name="sign_img" value="" />
            </li>-->
            <li>
            ...
            <li>
        		...
        		<input type="text" id="date_of_birth" name="date_of_birth" class="hasDatepicker">
        		<input type="hidden" id="dob_alt" name="dob_alt" size="30" value="<?php if(isset($data['hrmVariables'])){ echo $data['hrmVariables']['date_of_birth']; } ?>">
            </li>
           <li>
          ...
          <tr>
            ...
            <td width="280" height="35">
              <div align="left">
                <ul>
                  <li>
                    <input type="checkbox" name="identity_proof" id="identity_proof" <?php if(isset($data['hrmVariables']['identity_proof']) && $data['hrmVariables']['identity_proof']==1){ echo 'checked="checked"'; } ?> />
                    Identitt Proof                  
                    <input type="checkbox" name="id_NA" id="id_NA" />
                    NA
                  </li>
                  <li>
                    ...
                    Adress Proof                                    
                    <input type="checkbox" name="ap_NA" id="ap_NA" />
NA </li>
                  </ul>
              </div>
              </td>
...
NA </li>
                  ...
                  Graduation                  
                    <input type="checkbox" name="id_NA5" id="id_NA5" />
NA </li>
                  <li>
                  ...
                  Post Graduation                  
                    <input type="checkbox" name="id_NA6" id="id_NA6" />
NA </li>
                  <li>other 
              ...
              <div align="left">
                <ul>
                  <li>
                    ...
                    <input type="checkbox" name="id_NA7" id="id_NA7" />
NA </li>
                  <li>
                    ...
                    Relieving letter                                    
                    <input type="checkbox" name="id_NA8" id="id_NA8" />
NA </li>
                  <li>
                    ...
                    <input type="checkbox" name="id_NA9" id="id_NA9" />
NA </li>
                </ul>
              </div>
              </td>
